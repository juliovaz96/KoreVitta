...
"[project]/src/app/(patient)/today/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function PatientTodayPage() {
    ...
    if ($[0] !== "39a6e334972c17513030406acc983ee97da32f8364817edd2351950ed57fcb06") {
        for(let $i = 0; $i < 82; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "39a6e334972c17513030406acc983ee97da32f8364817edd2351950ed57fcb06";
    }
    const { data, loading, error, reload } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$today$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToday"])();
    let t0;
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
        t0 = {};
        $[1] = t0;
    ...
    const [localCompleted, setLocalCompleted] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(t0);
    let t1;
    bb0: {
        if (!data) {
            let t2;
        ...
        let t2;
        if ($[3] !== data.tasks || $[4] !== localCompleted) {
            let t3;
            if ($[6] !== localCompleted) {
                t3 = ({
                    "PatientTodayPage[data.tasks.map()]": (task)=>({
                            ...task,
                            completed: localCompleted[task.id] ?? task.completed
                        })
                })["PatientTodayPage[data.tasks.map()]"];
                $[6] = localCompleted;
                $[7] = t3;
            } else {
                t3 = $[7];
            }
            t2 = data.tasks.map(t3);
            $[3] = data.tasks;
            $[4] = localCompleted;
            $[5] = t2;
        } else {
    ...
    if (loading) {
        ...
        if ($[8] === Symbol.for("react.memo_cache_sentinel")) {
            t2 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$shared$2f$data$2d$states$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LoadingState"], {
                label: "Carregamento da rotina do dia"
            }, void 0, false, {
                fileName: "[project]/src/app/(patient)/today/page.tsx",
                lineNumber: 73,
                columnNumber: 12
            }, this);
            $[8] = t2;
    ...
    if (error) {
        ...
        if ($[9] !== reload) {
            t2 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$shared$2f$data$2d$states$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ErrorState"], {
                ...
                onRetry: {
                    "PatientTodayPage[<ErrorState>.onRetry]": ()=>{
                        reload();
                    }
                }["PatientTodayPage[<ErrorState>.onRetry]"]
            }, void 0, false, {
    ...
    let t2;
    if ($[12] !== tasks) {
        t2 = tasks.filter(_PatientTodayPageTasksFilter);
        $[12] = tasks;
        $[13] = t2;
    } else {
        t2 = $[13];
    ...
    let t3;
    if ($[14] !== completedCount || $[15] !== tasks.length) {
        t3 = tasks.length > 0 ? Math.round(completedCount / tasks.length * 100) : 0;
        $[14] = completedCount;
        $[15] = tasks.length;
        $[16] = t3;
    } else {
    ...
    const progressPct = t3;
    let t4;
    if ($[17] !== data.waterCurrentMl || $[18] !== data.waterTargetMl) {
        t4 = Math.round(data.waterCurrentMl / data.waterTargetMl * 100);
        $[17] = data.waterCurrentMl;
        $[18] = data.waterTargetMl;
        $[19] = t4;
    } else {
        t4 = $[19];
    }
    const waterPct = Math.min(100, t4);
    let t5;
    ...
    if ($[21] !== data.greetingName) {
        ...
        $[21] = data.greetingName;
        $[22] = t6;
    } else {
        t6 = $[22];
    }
    let t7;
    if ($[23] !== data.objective || $[24] !== data.statusLabel || $[25] !== data.weekProgressLabel) {
        ...
        $[23] = data.objective;
        $[24] = data.statusLabel;
        $[25] = data.weekProgressLabel;
        $[26] = t7;
    } else {
        t7 = $[26];
    }
    let t8;
    if ($[27] !== data.nextCheckinLabel) {
    ...
    let t12;
    if ($[35] !== completedCount || $[36] !== tasks.length) {
    ...
    if ($[56] === Symbol.for("react.memo_cache_sentinel")) {
        t23 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
            ...
            children: "Marque o que já foi concluído para acompanhar seu progresso."
        }, void 0, false, {
            fileName: "[project]/src/app/(patient)/today/page.tsx",
            lineNumber: 280,
            columnNumber: 11
    ...
    if ($[57] !== tasks) {
        ...
        if ($[59] === Symbol.for("react.memo_cache_sentinel")) {
            t25 = ({
                "PatientTodayPage[tasks.map()]": (task_1)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                        type: "checkbox",
                                        checked: task_1.completed,
                                        onChange: {
                                            "PatientTodayPage[tasks.map() > <input>.onChange]": (event)=>{
                                                setLocalCompleted({
                                                    "PatientTodayPage[tasks.map() > <input>.onChange > setLocalCompleted()]": (previous)=>({
                                                            ...previous,
                                                            [task_1.id]: event.target.checked
                                                        })
                                                }["PatientTodayPage[tasks.map() > <input>.onChange > setLocalCompleted()]"]);
                                            }
                                        }["PatientTodayPage[tasks.map() > <input>.onChange]"]
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/(patient)/today/page.tsx",
                                        lineNumber: 290,
                                        columnNumber: 229
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                className: "kv-pill capitalize",
                                children: task_1.type
                            }, void 0, false, {
                                fileName: "[project]/src/app/(patient)/today/page.tsx",
                                lineNumber: 299,
                                columnNumber: 105
    ...
    let t27;
    if ($[63] !== data.waterCurrentMl || $[64] !== data.waterTargetMl) {
        ...
        $[63] = data.waterCurrentMl;
        $[64] = data.waterTargetMl;
        $[65] = t27;
    } else {
        t27 = $[65];
    }
    ...
    if ($[66] !== t28) {
        t29 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "mt-3 h-3 w-full rounded-full bg-muted",
    ...
    let t35;
    if ($[77] !== t11 || $[78] !== t21 || $[79] !== t25 || $[80] !== t34) {
...
_s(PatientTodayPage, "GXR/HZJs3UZEu1/2Kp+KSm4oY0k=", false, function() {
    return [
...
_c = PatientTodayPage;
function _PatientTodayPageTasksFilter(task_0) {
    return task_0.completed;
}
var _c;
__turbopack_context__.k.register(_c, "PatientTodayPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_fb022067._.js.map