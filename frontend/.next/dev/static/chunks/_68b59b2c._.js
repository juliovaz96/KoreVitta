...
"[project]/src/app/(professional)/patients/[id]/protocol/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function PatientProtocolPage() {
    ...
    if ($[0] !== "387b7f5148f909b5385b44b5e680eff373222b9f80387bc93873dbc1a8c931dd") {
        for(let $i = 0; $i < 40; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "387b7f5148f909b5385b44b5e680eff373222b9f80387bc93873dbc1a8c931dd";
    }
    const params = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useParams"])();
    const patientId = params.id;
    const patient = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$patients$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePatientDetails"])(patientId);
    const protocols = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$protocols$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePatientProtocols"])(patientId);
    ...
    let t0;
    if ($[1] !== protocols.data) {
        t0 = (protocols.data ?? []).find(_PatientProtocolPageAnonymous) ?? null;
        $[1] = protocols.data;
        $[2] = t0;
    } else {
        t0 = $[2];
    }
    const activeProtocol = t0;
    let t1;
    if ($[3] !== activeProtocol?.modules) {
        t1 = activeProtocol?.modules ?? [
            "nutrition",
            "training"
        ];
        $[3] = activeProtocol?.modules;
        $[4] = t1;
    } else {
        t1 = $[4];
    }
    const [selectedModules, setSelectedModules] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(t1);
    ...
    if (patient.error || protocols.error) {
        ...
        if ($[6] !== patient || $[7] !== protocols) {
            t2 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$shared$2f$data$2d$states$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ErrorState"], {
                description: "N\xE3o foi poss\xEDvel carregar o protocolo do paciente.",
                onRetry: {
                    "PatientProtocolPage[<ErrorState>.onRetry]": ()=>{
                        patient.reload();
                        protocols.reload();
                    }
                }["PatientProtocolPage[<ErrorState>.onRetry]"]
    ...
    if (!patient.data) {
        ...
        if ($[9] === Symbol.for("react.memo_cache_sentinel")) {
            t2 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$shared$2f$data$2d$states$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EmptyState"], {
                title: "Paciente n\xE3o encontrado",
                description: "N\xE3o foi poss\xEDvel carregar os dados para edi\xE7\xE3o de protocolo."
            }, void 0, false, {
                fileName: "[project]/src/app/(professional)/patients/[id]/protocol/page.tsx",
                lineNumber: 75,
                columnNumber: 12
    ...
    if ($[10] === Symbol.for("react.memo_cache_sentinel")) {
        t2 = ({
            "PatientProtocolPage[toggleModule]": (module)=>{
                setSelectedModules({
                    "PatientProtocolPage[toggleModule > setSelectedModules()]": (previous)=>previous.includes(module) ? previous.filter({
                            "PatientProtocolPage[toggleModule > setSelectedModules() > previous.filter()]": (item)=>item !== module
                        }["PatientProtocolPage[toggleModule > setSelectedModules() > previous.filter()]"]) : [
                            ...previous,
                            module
                        ]
                }["PatientProtocolPage[toggleModule > setSelectedModules()]"]);
            }
        })["PatientProtocolPage[toggleModule]"];
        $[10] = t2;
    } else {
        t2 = $[10];
    }
    const toggleModule = t2;
    let t3;
    let t4;
    ...
    const t8 = activeProtocol?.name ?? "Sem protocolo ativo";
    const t9 = activeProtocol ? ` • versão ${activeProtocol.version}` : "";
    let t10;
    if ($[18] !== t8 || $[19] !== t9) {
    ...
    let t11;
    if ($[21] !== selectedModules) {
        t11 = allModules.map({
            "PatientProtocolPage[allModules.map()]": (module_0)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                            ...
                            onChange: {
                                "PatientProtocolPage[allModules.map() > <input>.onChange]": ()=>toggleModule(module_0)
                            }["PatientProtocolPage[allModules.map() > <input>.onChange]"]
                        }, void 0, false, {
                            fileName: "[project]/src/app/(professional)/patients/[id]/protocol/page.tsx",
                            lineNumber: 146,
                            columnNumber: 182
        ...
        }["PatientProtocolPage[allModules.map()]"]);
        $[21] = selectedModules;
        $[22] = t11;
    } else {
        t11 = $[22];
    ...
    if ($[25] === Symbol.for("react.memo_cache_sentinel")) {
        t13 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
            variant: "outline",
            onClick: {
                "PatientProtocolPage[<Button>.onClick]": async ()=>{
                    await new Promise(_temp);
                    setSaveMessage("Rascunho salvo com sucesso.");
                }
            }["PatientProtocolPage[<Button>.onClick]"],
    ...
    const t15 = selectedModules.length === 0;
    let t16;
    if ($[27] !== t15) {
...
_s(PatientProtocolPage, "Kbu7uBqDaEULpZQZ50o3EGOXXS4=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useParams"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$patients$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePatientDetails"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$protocols$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePatientProtocols"]
    ];
});
_c = PatientProtocolPage;
function _temp2(resolve_0) {
    return setTimeout(resolve_0, 300);
}
function _temp(resolve) {
    return setTimeout(resolve, 300);
}
function _PatientProtocolPageAnonymous(protocol) {
    return protocol.status === "active";
}
var _c;
__turbopack_context__.k.register(_c, "PatientProtocolPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_68b59b2c._.js.map