...
function ProfessionalShell(t0) {
    ...
    if ($[0] !== "10adbbc8e5c0f0358a0e251760724d147bc48d4d5f0f9f233d9796e9e76d332e") {
        for(let $i = 0; $i < 33; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "10adbbc8e5c0f0358a0e251760724d147bc48d4d5f0f9f233d9796e9e76d332e";
    }
    const { children } = t0;
...
function LoadingState(t0) {
    ...
    if ($[0] !== "b2877c564230451e40a7d1041a0225843f65abf5615044beb83dc3fd80397a47") {
        for(let $i = 0; $i < 7; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "b2877c564230451e40a7d1041a0225843f65abf5615044beb83dc3fd80397a47";
    }
    const { label: t1 } = t0;
...
//# sourceMappingURL=src_e23bd6a8._.js.map