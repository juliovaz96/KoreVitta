...
function usePatientProtocols(patientId) {
    ...
    if ($[0] !== "9ae77b64ffdba7e33d2d309f57c67c29e74e7e590a8ed94ef30e690f0fa15bdb") {
        for(let $i = 0; $i < 7; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "9ae77b64ffdba7e33d2d309f57c67c29e74e7e590a8ed94ef30e690f0fa15bdb";
    }
    let t0;
    if ($[1] !== patientId) {
        t0 = ({
...
function useTemplates() {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$resource$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useResource"])(loader, t0, t1);
}
...
"[project]/src/app/(professional)/protocols/[id]/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ProtocolEditorPage() {
    ...
    if ($[0] !== "91e7577478e15760964a2a7e8b0d636a2b3a7a61758fb25a74214e3713dd902b") {
        for(let $i = 0; $i < 96; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "91e7577478e15760964a2a7e8b0d636a2b3a7a61758fb25a74214e3713dd902b";
    }
    const params = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useParams"])();
    const protocolId = params.id;
    const protocols = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$protocols$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePatientProtocols"])("pat_001");
    ...
    const items = t0;
    let t1;
    if ($[3] !== items || $[4] !== protocolId) {
        t1 = items.find({
            "ProtocolEditorPage[items.find()]": (item)=>item.id === protocolId
        }["ProtocolEditorPage[items.find()]"]) ?? items[0] ?? null;
        $[3] = items;
        $[4] = protocolId;
        $[5] = t1;
    } else {
    ...
    const [startsAtDraft, setStartsAtDraft] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [endsAtDraft, setEndsAtDraft] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    let t2;
    ...
    const [selectedModules, setSelectedModules] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(t2);
    if (protocols.loading) {
        ...
        if ($[7] === Symbol.for("react.memo_cache_sentinel")) {
            t3 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$shared$2f$data$2d$states$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LoadingState"], {
                ...
                fileName: "[project]/src/app/(professional)/protocols/[id]/page.tsx",
                lineNumber: 63,
                columnNumber: 12
            }, this);
            $[7] = t3;
    ...
    if (protocols.error) {
        ...
        if ($[8] !== protocols) {
            t3 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$shared$2f$data$2d$states$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ErrorState"], {
                description: "N\xE3o foi poss\xEDvel carregar os dados do protocolo.",
                onRetry: {
                    "ProtocolEditorPage[<ErrorState>.onRetry]": ()=>{
                        protocols.reload();
                    }
                }["ProtocolEditorPage[<ErrorState>.onRetry]"]
            }, void 0, false, {
    ...
    if (!protocol) {
        ...
        if ($[10] === Symbol.for("react.memo_cache_sentinel")) {
            t3 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$shared$2f$data$2d$states$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EmptyState"], {
                title: "Protocolo n\xE3o encontrado",
                description: "N\xE3o h\xE1 protocolo dispon\xEDvel para edi\xE7\xE3o neste ambiente de demonstra\xE7\xE3o."
            }, void 0, false, {
                fileName: "[project]/src/app/(professional)/protocols/[id]/page.tsx",
                lineNumber: 88,
                columnNumber: 12
    ...
    if ($[11] === Symbol.for("react.memo_cache_sentinel")) {
        t3 = ({
            "ProtocolEditorPage[toggleModule]": (module)=>{
                setSelectedModules({
                    "ProtocolEditorPage[toggleModule > setSelectedModules()]": (previous)=>previous.includes(module) ? previous.filter({
                            "ProtocolEditorPage[toggleModule > setSelectedModules() > previous.filter()]": (item_0)=>item_0 !== module
                        }["ProtocolEditorPage[toggleModule > setSelectedModules() > previous.filter()]"]) : [
                            ...previous,
                            module
                        ]
                }["ProtocolEditorPage[toggleModule > setSelectedModules()]"]);
            }
        })["ProtocolEditorPage[toggleModule]"];
        $[11] = t3;
    } else {
        t3 = $[11];
    }
    const toggleModule = t3;
    let t4;
    let t5;
    let t6;
    if ($[12] === Symbol.for("react.memo_cache_sentinel")) {
        ...
        t6 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
            ...
            children: "Edição do bundle integrado com controle de versão e módulos ativos."
        }, void 0, false, {
            fileName: "[project]/src/app/(professional)/protocols/[id]/page.tsx",
            lineNumber: 121,
            columnNumber: 10
    ...
    const t8 = protocol.status === "active" ? "success" : "warning";
    let t9;
    if ($[17] !== protocol.status || $[18] !== t8) {
    ...
    if ($[27] === Symbol.for("react.memo_cache_sentinel")) {
        t14 = ({
            "ProtocolEditorPage[<Input>.onChange]": (event)=>setNameDraft(event.target.value)
        })["ProtocolEditorPage[<Input>.onChange]"];
        $[27] = t14;
    } else {
        t14 = $[27];
    }
    ...
    if ($[37] === Symbol.for("react.memo_cache_sentinel")) {
        t20 = ({
            "ProtocolEditorPage[<Input>.onChange]": (event_0)=>setStartsAtDraft(event_0.target.value)
        })["ProtocolEditorPage[<Input>.onChange]"];
        $[37] = t20;
    } else {
        t20 = $[37];
    ...
    if ($[41] === Symbol.for("react.memo_cache_sentinel")) {
        t23 = ({
            "ProtocolEditorPage[<Input>.onChange]": (event_1)=>setEndsAtDraft(event_1.target.value)
        })["ProtocolEditorPage[<Input>.onChange]"];
        $[41] = t23;
    } else {
        t23 = $[41];
    ...
    let t27;
    if ($[48] !== effectiveModules) {
        t27 = allModules.map({
            "ProtocolEditorPage[allModules.map()]": (module_0)=>{
                const checked = effectiveModules.includes(module_0);
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                    className: "flex items-center gap-2 rounded-xl border border-border px-3 py-2 text-sm capitalize",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                            type: "checkbox",
                            checked: checked,
                            onChange: {
                                "ProtocolEditorPage[allModules.map() > <input>.onChange]": ()=>toggleModule(module_0)
                            }["ProtocolEditorPage[allModules.map() > <input>.onChange]"]
                        }, void 0, false, {
                            fileName: "[project]/src/app/(professional)/protocols/[id]/page.tsx",
                            lineNumber: 289,
                            columnNumber: 135
        ...
        }["ProtocolEditorPage[allModules.map()]"]);
        $[48] = effectiveModules;
        $[49] = t27;
    } else {
        t27 = $[49];
    ...
    if ($[53] === Symbol.for("react.memo_cache_sentinel")) {
        t30 = ({
            "ProtocolEditorPage[<Button>.onClick]": async ()=>{
                ...
                setSavedMessage("Nova vers\xE3o publicada e protocolo ativado.");
            }
        })["ProtocolEditorPage[<Button>.onClick]"];
        $[53] = t30;
    } else {
    ...
    const t34 = `/protocols/${protocol.id}/nutrition`;
    let t35;
    if ($[57] === Symbol.for("react.memo_cache_sentinel")) {
        t35 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
            variant: "ghost",
            children: "Editar Nutrição"
        }, void 0, false, {
            fileName: "[project]/src/app/(professional)/protocols/[id]/page.tsx",
            lineNumber: 355,
            columnNumber: 11
    ...
    const t37 = `/protocols/${protocol.id}/training`;
    let t38;
    ...
    let t41;
    if ($[67] !== t18 || $[68] !== t25 || $[69] !== t28 || $[70] !== t40) {
    ...
    if ($[75] === Symbol.for("react.memo_cache_sentinel")) {
        t44 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
            children: "O que mudou: ajustes de metas e módulos para a fase atual do paciente."
        }, void 0, false, {
            fileName: "[project]/src/app/(professional)/protocols/[id]/page.tsx",
            lineNumber: 422,
            columnNumber: 11
    ...
    let t45;
    if ($[76] !== protocol.startsAt) {
        t45 = new Date(protocol.startsAt).toLocaleDateString("pt-BR");
        $[76] = protocol.startsAt;
        $[77] = t45;
    } else {
        t45 = $[77];
    }
    let t46;
    if ($[78] !== protocol.endsAt) {
        t46 = protocol.endsAt ? ` até ${new Date(protocol.endsAt).toLocaleDateString("pt-BR")}` : "";
        $[78] = protocol.endsAt;
        $[79] = t46;
    } else {
        t46 = $[79];
    ...
    let t48;
    if ($[83] !== effectiveModules) {
        t48 = effectiveModules.join(", ");
        $[83] = effectiveModules;
        $[84] = t48;
    } else {
        t48 = $[84];
    ...
    let t51;
    if ($[91] !== t10 || $[92] !== t11 || $[93] !== t41 || $[94] !== t50) {
...
_s(ProtocolEditorPage, "xcnrH+7bpw6efpkC3Hz3FjKo55M=", false, function() {
    return [
...
_c = ProtocolEditorPage;
function _temp3(resolve_1) {
    return setTimeout(resolve_1, 300);
}
...
var _c;
__turbopack_context__.k.register(_c, "ProtocolEditorPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_6568ac7a._.js.map