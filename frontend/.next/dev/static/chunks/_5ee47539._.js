...
function usePatientCheckins(patientId) {
    ...
    if ($[0] !== "2c1ba9073d1308f01f441ff1c44feb8711601f098fcf59c2111cae3856bd4aff") {
        for(let $i = 0; $i < 7; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "2c1ba9073d1308f01f441ff1c44feb8711601f098fcf59c2111cae3856bd4aff";
    }
    let t0;
    if ($[1] !== patientId) {
        t0 = ({
...
"[project]/src/app/(patient)/progress/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function PatientProgressPage() {
    ...
    if ($[0] !== "4fcfe2c8fd2add6acd7ac6d93291bf63e440851e591951717cba779766521b94") {
        for(let $i = 0; $i < 68; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "4fcfe2c8fd2add6acd7ac6d93291bf63e440851e591951717cba779766521b94";
    }
    ...
    const checkins = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$checkins$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePatientCheckins"])("pat_001");
    if (today.loading || checkins.loading) {
        ...
        if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
            t0 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$shared$2f$data$2d$states$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LoadingState"], {
                label: "Carregamento do progresso"
            }, void 0, false, {
                fileName: "[project]/src/app/(patient)/progress/page.tsx",
                lineNumber: 23,
                columnNumber: 12
            }, this);
            $[1] = t0;
    ...
    if (today.error || checkins.error) {
        ...
        if ($[2] !== checkins || $[3] !== today) {
            t0 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$shared$2f$data$2d$states$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ErrorState"], {
                ...
                onRetry: {
                    "PatientProgressPage[<ErrorState>.onRetry]": ()=>{
                        today.reload();
                        checkins.reload();
                    }
                }["PatientProgressPage[<ErrorState>.onRetry]"]
    ...
    let t0;
    if ($[5] !== today.data?.tasks) {
        t0 = today.data?.tasks.filter(_PatientProgressPageAnonymous).length ?? 0;
        $[5] = today.data?.tasks;
        $[6] = t0;
    } else {
        t0 = $[6];
    }
    const completedTasks = t0;
    const totalTasks = today.data?.tasks.length ?? 0;
    let t1;
    if ($[7] !== completedTasks || $[8] !== totalTasks) {
        t1 = totalTasks > 0 ? Math.round(completedTasks / totalTasks * 100) : 0;
        $[7] = completedTasks;
        $[8] = totalTasks;
        $[9] = t1;
    } else {
    ...
    const checkinHistory = t2;
    let t3;
    if ($[12] !== checkinHistory) {
        t3 = checkinHistory.filter(_PatientProgressPageCheckinHistoryFilter);
        $[12] = checkinHistory;
        $[13] = t3;
    } else {
        t3 = $[13];
    }
    const completedCheckins = t3.length;
    let t4;
    if ($[14] !== dailyAdherence) {
        t4 = {
            label: "Ader\xEAncia di\xE1ria",
            value: dailyAdherence
        };
        $[14] = dailyAdherence;
        $[15] = t4;
    } else {
    ...
    let t5;
    if ($[16] !== checkinHistory.length || $[17] !== completedCheckins) {
        t5 = checkinHistory.length > 0 ? Math.round(completedCheckins / checkinHistory.length * 100) : 0;
        $[16] = checkinHistory.length;
        $[17] = completedCheckins;
        $[18] = t5;
    } else {
        t5 = $[18];
    }
    ...
    let t7;
    if ($[21] !== today.data) {
        t7 = today.data && today.data.waterTargetMl > 0 ? Math.min(100, Math.round(today.data.waterCurrentMl / today.data.waterTargetMl * 100)) : 0;
        $[21] = today.data;
        $[22] = t7;
    } else {
        t7 = $[22];
    ...
    if ($[29] === Symbol.for("react.memo_cache_sentinel")) {
        ...
        t12 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
            ...
            children: "Evolução semanal com foco em aderência, check-ins e consistência de rotina."
        }, void 0, false, {
            fileName: "[project]/src/app/(patient)/progress/page.tsx",
            lineNumber: 152,
            columnNumber: 11
    ...
    let t18;
    if ($[39] !== checkinHistory.length || $[40] !== completedCheckins) {
        t18 = checkinHistory.length > 0 ? Math.round(completedCheckins / checkinHistory.length * 100) : 0;
        $[39] = checkinHistory.length;
        $[40] = completedCheckins;
        $[41] = t18;
    } else {
        t18 = $[41];
    }
    ...
    const t22 = progressionBars[2]?.value ?? 0;
    let t23;
    if ($[47] !== t22) {
    ...
    if ($[56] === Symbol.for("react.memo_cache_sentinel")) {
        t27 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardTitle"], {
                children: "Indicadores da semana"
            }, void 0, false, {
                fileName: "[project]/src/app/(patient)/progress/page.tsx",
                lineNumber: 266,
                columnNumber: 23
    ...
    let t28;
    if ($[57] !== progressionBars) {
        t28 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
            children: [
                t27,
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                    className: "space-y-3",
                    children: progressionBars.map(_PatientProgressPageProgressionBarsMap)
                }, void 0, false, {
                    fileName: "[project]/src/app/(patient)/progress/page.tsx",
                    lineNumber: 273,
                    columnNumber: 22
    ...
    let t30;
    if ($[60] !== checkinHistory) {
        t30 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
            children: [
                t29,
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                    children: checkinHistory.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                        className: "space-y-2 text-sm",
                        children: checkinHistory.map(_PatientProgressPageCheckinHistoryMap)
                    }, void 0, false, {
                        fileName: "[project]/src/app/(patient)/progress/page.tsx",
                        lineNumber: 288,
                        columnNumber: 64
                        ...
                        onCta: _PatientProgressPageEmptyStateOnCta
                    }, void 0, false, {
                        fileName: "[project]/src/app/(patient)/progress/page.tsx",
                        lineNumber: 288,
                        columnNumber: 165
...
_s(PatientProgressPage, "yuNXhr3PnntS4ZgBookF2o+362E=", false, function() {
    return [
...
_c = PatientProgressPage;
function _PatientProgressPageEmptyStateOnCta() {
    window.location.href = "/checkin";
}
function _PatientProgressPageCheckinHistoryMap(item_0) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                ...
                children: new Date(item_0.scheduledAt).toLocaleDateString("pt-BR")
            }, void 0, false, {
                fileName: "[project]/src/app/(patient)/progress/page.tsx",
                lineNumber: 324,
                columnNumber: 87
...
function _PatientProgressPageProgressionBarsMap(bar) {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "h-2 rounded-full bg-linear-to-r from-primary to-chart-2",
                    style: {
                        width: `${bar.value}%`
                    }
                }, void 0, false, {
...
function _PatientProgressPageCheckinHistoryFilter(item) {
    return item.status === "completed";
}
function _PatientProgressPageAnonymous(task) {
    return task.completed;
}
var _c;
__turbopack_context__.k.register(_c, "PatientProgressPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_5ee47539._.js.map