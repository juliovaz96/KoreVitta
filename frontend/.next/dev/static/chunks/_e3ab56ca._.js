...
"[project]/src/app/(professional)/patients/[id]/checkins/[checkinId]/review/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function CheckinReviewPage() {
    ...
    if ($[0] !== "9bb831f9e269859ca10efa7f3807012c7b8d5d193dacc7754e39b0cd8a7b64d0") {
        for(let $i = 0; $i < 76; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "9bb831f9e269859ca10efa7f3807012c7b8d5d193dacc7754e39b0cd8a7b64d0";
    }
    ...
    const [riskScore, setRiskScore] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(50);
    const [reviewed, setReviewed] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    if (patient.loading || checkins.loading) {
        ...
        if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
            t0 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$shared$2f$data$2d$states$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LoadingState"], {
                label: "Carregando revis\xE3o do check-in"
            }, void 0, false, {
                fileName: "[project]/src/app/(professional)/patients/[id]/checkins/[checkinId]/review/page.tsx",
                lineNumber: 31,
                columnNumber: 12
            }, this);
            $[1] = t0;
    ...
    if (patient.error || checkins.error) {
        ...
        if ($[2] !== checkins || $[3] !== patient) {
            t0 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$shared$2f$data$2d$states$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ErrorState"], {
                description: "N\xE3o foi poss\xEDvel carregar os dados de revis\xE3o.",
                onRetry: {
                    "CheckinReviewPage[<ErrorState>.onRetry]": ()=>{
                        patient.reload();
                        checkins.reload();
                    }
                }["CheckinReviewPage[<ErrorState>.onRetry]"]
    ...
    let t8;
    let t9;
    if ($[5] !== checkinId || $[6] !== checkins.data || $[7] !== patient.data) {
        t9 = Symbol.for("react.early_return_sentinel");
        bb0: {
            const checkinItems = checkins.data ?? [];
            selectedCheckin = checkinItems.find({
                "CheckinReviewPage[checkinItems.find()]": (item)=>item.id === checkinId
            }["CheckinReviewPage[checkinItems.find()]"]) ?? checkinItems[0] ?? null;
            if (!selectedCheckin || !patient.data) {
                ...
                if ($[19] === Symbol.for("react.memo_cache_sentinel")) {
                    t10 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$shared$2f$data$2d$states$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EmptyState"], {
                        title: "Check-in n\xE3o encontrado",
                        description: "N\xE3o h\xE1 dados de check-in para o paciente selecionado."
                    }, void 0, false, {
                        fileName: "[project]/src/app/(professional)/patients/[id]/checkins/[checkinId]/review/page.tsx",
                        lineNumber: 76,
                        columnNumber: 17
            ...
            t8 = "mx-auto flex w-full max-w-5xl flex-col gap-5";
            t5 = "kv-surface rounded-3xl p-6";
            ...
            t0 = "mt-2 text-sm text-muted-foreground";
            t1 = "Paciente: ";
            t2 = patient.data.name;
            t3 = " \u2022 Check-in: ";
            t4 = new Date(selectedCheckin.scheduledAt).toLocaleDateString("pt-BR");
        }
        $[5] = checkinId;
        $[6] = checkins.data;
        $[7] = patient.data;
    ...
    let t10;
    if ($[22] !== t0 || $[23] !== t1 || $[24] !== t2 || $[25] !== t3 || $[26] !== t4) {
    ...
    if ($[36] !== selectedCheckin.status) {
        ...
        $[36] = selectedCheckin.status;
        $[37] = t14;
    } else {
        t14 = $[37];
    }
    const t15 = selectedCheckin.adherenceNutrition ?? "\u2014";
    let t16;
    if ($[38] !== t15) {
    ...
    const t17 = selectedCheckin.adherenceTraining ?? "\u2014";
    let t18;
    if ($[40] !== t17) {
    ...
    if ($[42] === Symbol.for("react.memo_cache_sentinel")) {
        t19 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
            ...
            children: "Fotos e anexos entram na próxima iteração do fluxo clínico."
        }, void 0, false, {
            fileName: "[project]/src/app/(professional)/patients/[id]/checkins/[checkinId]/review/page.tsx",
            lineNumber: 197,
            columnNumber: 11
    ...
    if ($[50] === Symbol.for("react.memo_cache_sentinel")) {
        t23 = ({
            "CheckinReviewPage[<input>.onChange]": (event)=>setRiskScore(Number(event.target.value))
        })["CheckinReviewPage[<input>.onChange]"];
        $[50] = t23;
    } else {
        t23 = $[50];
    }
    ...
    if ($[57] === Symbol.for("react.memo_cache_sentinel")) {
        t27 = ({
            "CheckinReviewPage[<textarea>.onChange]": (event_0)=>setNotes(event_0.target.value)
        })["CheckinReviewPage[<textarea>.onChange]"];
        $[57] = t27;
    } else {
        t27 = $[57];
    }
        ...
        t28 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("textarea", {
                    id: "notes",
                    className: "min-h-28 w-full rounded-xl border border-input/80 bg-card/70 px-3 py-2 text-sm",
                    value: notes,
                    onChange: t27,
                    placeholder: "Orienta\xE7\xF5es e pr\xF3ximos ajustes..."
                }, void 0, false, {
                    fileName: "[project]/src/app/(professional)/patients/[id]/checkins/[checkinId]/review/page.tsx",
                    lineNumber: 271,
                    columnNumber: 43
    ...
    if ($[60] === Symbol.for("react.memo_cache_sentinel")) {
        t29 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
            onClick: {
                "CheckinReviewPage[<Button>.onClick]": async ()=>{
                    await new Promise(_temp);
                    setReviewed(true);
                }
            }["CheckinReviewPage[<Button>.onClick]"],
            children: "Marcar como revisado"
        }, void 0, false, {
            fileName: "[project]/src/app/(professional)/patients/[id]/checkins/[checkinId]/review/page.tsx",
            lineNumber: 279,
            columnNumber: 11
    ...
    const t32 = `/patients/${patientId}/checkins`;
    let t33;
    if ($[67] === Symbol.for("react.memo_cache_sentinel")) {
        t33 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
            variant: "outline",
            children: "Voltar para check-ins"
        }, void 0, false, {
            fileName: "[project]/src/app/(professional)/patients/[id]/checkins/[checkinId]/review/page.tsx",
            lineNumber: 310,
            columnNumber: 11
    ...
    let t35;
    if ($[70] !== t11 || $[71] !== t12 || $[72] !== t31 || $[73] !== t34 || $[74] !== t8) {
...
_s(CheckinReviewPage, "d/d+aDhuhdeeSZil1IyAL2pN5V8=", false, function() {
    return [
...
_c = CheckinReviewPage;
function _temp(resolve) {
    return setTimeout(resolve, 400);
}
var _c;
__turbopack_context__.k.register(_c, "CheckinReviewPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_e3ab56ca._.js.map