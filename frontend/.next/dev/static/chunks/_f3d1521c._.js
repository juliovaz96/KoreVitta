...
"[project]/src/hooks/use-messages.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useThreads() {
    ...
    if ($[0] !== "13ba559406f8a215afaeb7dacaeefdaf667a6121a1321ddef44f27cf015068d1") {
        for(let $i = 0; $i < 3; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "13ba559406f8a215afaeb7dacaeefdaf667a6121a1321ddef44f27cf015068d1";
    }
    const loader = _useThreadsLoader;
    let t0;
    let t1;
...
_s(useThreads, "xSJT3Bg8baofBRL2vAM/ILmt1Dg=", false, function() {
    return [
...
function _useThreadsLoader() {
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].listThreads();
}
function useMessages(threadId) {
    ...
    if ($[1] !== threadId) {
        t0 = ({
            "useMessages[loader]": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].listMessages(threadId)
        })["useMessages[loader]"];
        $[1] = threadId;
        $[2] = t0;
    } else {
...
_s1(useMessages, "xSJT3Bg8baofBRL2vAM/ILmt1Dg=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$resource$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useResource"]
    ];
});
...
"[project]/src/app/(patient)/messages/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/compiler-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$messages$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/hooks/use-messages.ts [app-client] (ecmascript)");
...
function PatientMessagesPage() {
    ...
    if ($[0] !== "1cd8a046fb511f067db1d13b7e6a94bf2c14517c2ad566bf50eb7acc8f7adade") {
        for(let $i = 0; $i < 37; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "1cd8a046fb511f067db1d13b7e6a94bf2c14517c2ad566bf50eb7acc8f7adade";
    }
    const threads = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$messages$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useThreads"])();
    ...
    const [lastSentAt, setLastSentAt] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    let t0;
    if ($[1] !== selectedThreadId || $[2] !== threads.data) {
        t0 = threads.data?.find({
            "PatientMessagesPage[(anonymous)()]": (thread)=>thread.id === selectedThreadId
        }["PatientMessagesPage[(anonymous)()]"]) ?? threads.data?.[0] ?? null;
        $[1] = selectedThreadId;
        $[2] = threads.data;
        $[3] = t0;
    } else {
    ...
    const activeThread = t0;
    const messages = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$messages$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMessages"])(activeThread?.id ?? "");
    let t1;
    if ($[4] !== composer) {
        t1 = ({
            "PatientMessagesPage[handleSend]": ()=>{
                if (!composer.trim()) {
                    return;
                }
                setComposer("");
    ...
    if (threads.loading) {
        ...
        if ($[6] === Symbol.for("react.memo_cache_sentinel")) {
            t2 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$shared$2f$data$2d$states$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LoadingState"], {
                label: "Carregamento das mensagens"
            }, void 0, false, {
                fileName: "[project]/src/app/(patient)/messages/page.tsx",
                lineNumber: 56,
                columnNumber: 12
            }, this);
            $[6] = t2;
    ...
    if (threads.error) {
        ...
        if ($[7] !== threads) {
            t2 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$shared$2f$data$2d$states$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ErrorState"], {
                ...
                onRetry: {
                    "PatientMessagesPage[<ErrorState>.onRetry]": ()=>{
                        threads.reload();
                    }
                }["PatientMessagesPage[<ErrorState>.onRetry]"]
            }, void 0, false, {
    ...
    if ($[10] === Symbol.for("react.memo_cache_sentinel")) {
        ...
        t4 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
            ...
            children: "Converse com seu profissional sem sair do app."
        }, void 0, false, {
            fileName: "[project]/src/app/(patient)/messages/page.tsx",
            lineNumber: 95,
            columnNumber: 10
    ...
    let t7;
    if ($[16] !== activeThread?.id || $[17] !== threads.data) {
        let t8;
        if ($[19] !== activeThread?.id) {
            t8 = ({
                "PatientMessagesPage[threads.data.map()]": (thread_0)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        type: "button",
                        className: `rounded-xl border px-3 py-2 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/40 focus-visible:ring-offset-2 ${thread_0.id === activeThread?.id ? "border-primary bg-primary/15" : "border-border bg-card"}`,
                        onClick: {
                            "PatientMessagesPage[threads.data.map() > <button>.onClick]": ()=>setSelectedThreadId(thread_0.id)
                        }["PatientMessagesPage[threads.data.map() > <button>.onClick]"],
                        "aria-pressed": thread_0.id === activeThread?.id,
                        "aria-current": thread_0.id === activeThread?.id ? "true" : undefined,
                        children: [
                            thread_0.patientName,
                            thread_0.unreadCount > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$badge$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Badge"], {
                                variant: "warning",
                                className: "ml-2",
                                children: thread_0.unreadCount
                            }, void 0, false, {
                                fileName: "[project]/src/app/(patient)/messages/page.tsx",
                                lineNumber: 126,
                                columnNumber: 241
            ...
            })["PatientMessagesPage[threads.data.map()]"];
            $[19] = activeThread?.id;
            $[20] = t8;
        } else {
            t8 = $[20];
        }
        t7 = threads.data.map(t8);
        $[16] = activeThread?.id;
        $[17] = threads.data;
        $[18] = t7;
    } else {
    ...
    let t10;
    if ($[25] !== composer || $[26] !== handleSend || $[27] !== lastSentAt || $[28] !== messages) {
        t10 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
            children: messages.loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$shared$2f$data$2d$states$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LoadingState"], {
                label: "Carregamento da conversa"
            }, void 0, false, {
                fileName: "[project]/src/app/(patient)/messages/page.tsx",
                lineNumber: 158,
                columnNumber: 44
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                        className: "space-y-2",
                        children: (messages.data ?? []).map(_PatientMessagesPageAnonymous)
                    }, void 0, false, {
                        fileName: "[project]/src/app/(patient)/messages/page.tsx",
                        lineNumber: 162,
                        columnNumber: 62
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                        ...
                        onSubmit: {
                            "PatientMessagesPage[<form>.onSubmit]": (event)=>{
                                event.preventDefault();
                                handleSend();
                            }
                        }["PatientMessagesPage[<form>.onSubmit]"],
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$input$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Input"], {
                                placeholder: "Escreva sua mensagem...",
                                value: composer,
                                onChange: {
                                    "PatientMessagesPage[<Input>.onChange]": (event_0)=>setComposer(event_0.target.value)
                                }["PatientMessagesPage[<Input>.onChange]"]
                            }, void 0, false, {
                                fileName: "[project]/src/app/(patient)/messages/page.tsx",
                                lineNumber: 167,
                                columnNumber: 52
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        "aria-live": "polite",
                        children: lastSentAt ? "Mensagem enviada para revis\xE3o do profissional." : "Pressione Enter para enviar mais r\xE1pido."
                    }, void 0, false, {
                        fileName: "[project]/src/app/(patient)/messages/page.tsx",
                        lineNumber: 169,
                        columnNumber: 138
...
_s(PatientMessagesPage, "Mflut1+jtyoqovGfQ18jPskbpls=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$messages$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useThreads"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$messages$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMessages"]
    ];
});
_c = PatientMessagesPage;
function _PatientMessagesPageAnonymous(message) {
...
var _c;
__turbopack_context__.k.register(_c, "PatientMessagesPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_f3d1521c._.js.map