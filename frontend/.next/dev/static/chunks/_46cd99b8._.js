...
function PatientsListPage() {
    ...
    if ($[0] !== "064cd449deddb44cdf0f8c626767b720b55d5ab575dec8e0dc0cbf56591da6db") {
        for(let $i = 0; $i < 65; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "064cd449deddb44cdf0f8c626767b720b55d5ab575dec8e0dc0cbf56591da6db";
    }
    ...
    let t2;
    if ($[5] !== data) {
        t2 = data?.filter(_PatientsListPageAnonymous).length ?? 0;
        $[5] = data;
        $[6] = t2;
    } else {
        t2 = $[6];
    }
    const atRiskPatients = t2;
    let t3;
    if ($[7] !== data) {
        t3 = data?.filter(_PatientsListPageAnonymous2).length ?? 0;
        $[7] = data;
        $[8] = t3;
    } else {
        t3 = $[8];
    }
    const activePatients = t3;
    if (loading) {
        let t4;
    ...
    let t25;
    if ($[43] !== status) {
        t25 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
    ...
    let t32;
    if ($[53] !== t18 || $[54] !== t25 || $[55] !== t29 || $[56] !== t31) {
...
function _PatientsListPageDataMap(patient_1) {
...
//# sourceMappingURL=_46cd99b8._.js.map